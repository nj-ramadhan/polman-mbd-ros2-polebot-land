# launch/polebot_land_bringup.launch.py
...
def generate_launch_description():
    ...
    pkg_polebot_bringup = get_package_share_directory('polebot_land_bringup')
    pkg_slam_toolbox = get_package_share_directory('slam_toolbox')
    pkg_nav2_bringup = get_package_share_directory('nav2_bringup')

    # Config file path
    nav2_params_file = PathJoinSubstitution([
        pkg_polebot_description, 'config', 'polebot_land_nav2_params.yaml'
    ])
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                PathJoinSubstitution([pkg_polebot_description, 'launch', 'polebot_land_rviz.launch.py'])
            )
        ),
