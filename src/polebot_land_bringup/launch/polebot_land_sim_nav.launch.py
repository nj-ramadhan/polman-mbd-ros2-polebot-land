...
def generate_launch_description():
    ...
    pkg_polebot_simulation = get_package_share_directory('polebot_land_simulation')
    pkg_polebot_description = get_package_share_directory('polebot_land_description')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(pkg_polebot_description, 'config', 'polebot_land_nav2_params.yaml'),
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(pkg_polebot_description, 'src', 'description', 'polebot_land_description.sdf'),
    ...
    gz_robot = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_polebot_simulation, 'launch', 'polebot_land_spawn.launch.py')),
